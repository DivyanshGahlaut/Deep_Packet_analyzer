#ifndef SENTRY_PACKET_PARSER_H
#define SENTRY_PACKET_PARSER_H
...
class LayerParser {
public:
    // Parse a raw packet and fill in the SentryPacket structure
    static bool parse(const SentryRawPacket& raw, SentryPacket& parsed);
...
private:
    static bool parseEthernet(const uint8_t* data, size_t len, SentryPacket& parsed, size_t& offset);
    static bool parseIPv4(const uint8_t* data, size_t len, SentryPacket& parsed, size_t& offset);
    static bool parseTCP(const uint8_t* data, size_t len, SentryPacket& parsed, size_t& offset);
    static bool parseUDP(const uint8_t* data, size_t len, SentryPacket& parsed, size_t& offset);
};
